  ...
  return (
    <style>{`
      :root {
        ...
        --shadow-pop: 0 8px 22px rgba(255,122,77,0.30);
      }
      ...
      .font-cn { font-family: 'Plus Jakarta Sans', system-ui, sans-serif; }
...
function PrimaryButton({ children, className = "", tone = "cyan", ...props }) {
  const tones = {
    cyan: "bg-[var(--accent-strong)] text-white shadow-[var(--shadow-pop)] hover:bg-[var(--accent)] hover:-translate-y-0.5",
    gold: "border border-[var(--notice)]/40 bg-[var(--notice)]/10 text-[var(--notice)] hover:bg-[var(--notice)]/16",
    red: "border border-[var(--neg)]/40 bg-[var(--neg)]/10 text-[var(--neg)] hover:bg-[var(--neg)]/16",
    ghost: "border border-[var(--border-strong)] bg-[var(--surface)] text-[var(--ink)] hover:bg-[var(--surface-2)]",
  };
  ...
  return (
    <button
      type="button"
      className={cn(
        "rounded-xl px-6 py-3 text-sm font-bold tracking-[0.01em] transition duration-200 disabled:pointer-events-none disabled:opacity-40",
        tones[tone],
        className,
      )}
      {...props}
    ...
    <header className="sticky top-0 z-30 -mx-4 border-b border-[var(--border)] bg-[var(--bg)]/80 px-4 backdrop-blur-md">
      <div className="mx-auto flex w-full max-w-[1320px] items-center justify-between gap-4 py-3">
        ...
        <nav className="flex items-center gap-1">
          ...
          >
            <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[linear-gradient(135deg,#ff7a4d,#2e4a8f)] font-terminal text-xs font-black text-[#0b1018]">
              {initials}
            </span>
            <svg
              viewBox="0 0 20 20"
          ...
          {menuOpen && (
            <div
              role="menu"
              aria-label="Account"
              className="absolute right-0 z-30 mt-2 w-56 overflow-hidden rounded-2xl border border-[var(--border-strong)] bg-[var(--bg-elev)] shadow-[0_18px_44px_rgba(0,0,0,0.55)]"
            >
    ...
    <TerminalCard className="h-full overflow-hidden">
      ...
      <div className="p-5">
        <div className="mb-5 flex items-center gap-4">
          <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-[linear-gradient(135deg,#ff7a4d,#2e4a8f)] font-terminal text-2xl font-black text-[#0b1018] shadow-[var(--shadow)]">
            M
          </div>
          <div>
        ...
        <div className="min-h-36 rounded-xl border-l-4 border-[#ff7a4d] bg-[var(--surface-2)] p-4 text-base leading-8 text-[var(--ink)]">
            ...
            <div className="space-y-5">
              {entries.map((entry) => (
                <div key={entry.id} className="scene-enter">
                  <div className="mb-4 rounded-xl border border-[#fbbf24]/25 bg-[#fbbf24]/[0.06] p-4">
...
function AuthScreen({ authError, setAuthError, onGuest }) {
  ...
  const inputClass =
    "w-full rounded-xl border border-[var(--border-strong)] bg-[var(--bg-elev)] px-3 py-2.5 text-sm text-[var(--ink)] placeholder:text-[var(--faint)] outline-none transition-colors duration-200 focus:border-[var(--accent)]";
  const labelClass =
  ...
  return (
    <div className="scene-enter relative z-10 mx-auto flex min-h-screen max-w-md flex-col items-center justify-center px-6 py-16">
      ...
      <div className="mt-8 w-full rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 shadow-[var(--shadow)]">
        {/* Segmented toggle: Sign In / Create Account */}
        <div className="mb-6 grid grid-cols-2 gap-1 rounded-2xl border border-[var(--border)] bg-[var(--bg-elev)] p-1">
          <button
            type="button"
            onClick={() => switchMode("signin")}
            aria-pressed={!isSignup}
            className={cn(
              "rounded-xl px-3 py-2 text-xs font-semibold tracking-[0.04em] transition-colors duration-200",
              !isSignup
  ...
  return (
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="grid gap-6 p-6 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="flex flex-col items-center justify-center rounded-2xl border border-[#fbbf24]/20 bg-[#fbbf24]/[0.05] p-6 text-center">
          <div className="mb-5 flex h-28 w-28 items-center justify-center rounded-full bg-[linear-gradient(135deg,#ff7a4d,#2e4a8f)] font-terminal text-5xl font-black text-[#0b1018] shadow-[var(--shadow)]">
            M
          </div>
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={label} className="rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-5">
      ...
      <div className="space-y-5 p-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {[
            ...
            <div key={title} className="rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-5">
        ...
        <div className="rounded-xl border-l-4 border-[#fbbf24] bg-[#fbbf24]/[0.06] p-4 text-sm leading-7 text-[var(--notice)]">
    ...
    <div className="mt-6 rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-5">
      ...
      <div className="grid gap-5 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <svg viewBox="0 0 620 230" className="h-auto w-full" role="img" aria-label="Call and Put expiry-direction chart">
            <defs>
              ...
              <linearGradient id="putZone" x1="1" x2="0">
                <stop offset="0%" stopColor="rgba(255,122,77,0)" />
                <stop offset="100%" stopColor="rgba(255,122,77,0.2)" />
              </linearGradient>
            </defs>

            <rect x="35" y="36" width="260" height="118" rx="8" fill="url(#putZone)" stroke="rgba(255,122,77,0.22)" />
            <rect x="325" y="36" width="260" height="118" rx="8" fill="url(#callZone)" stroke="rgba(251,191,36,0.22)" />
            ...
            <text x="310" y="44" textAnchor="middle" className="fill-[#ece9e3] text-[13px]">
              Strike 100
            </text>
            ...
            {points.map((point) => {
              ...
              return (
                <g key={point}>
                  ...
                  <text x={x} y="160" textAnchor="middle" className="fill-[#a7a299] text-[12px]">
                    {point}
                  </text>
                </g>
              );
            ...
            <text x="118" y="74" className="fill-[#ff7a4d] text-[16px] font-bold">
              Put Wins
            </text>
            <text x="420" y="74" className="fill-[#fbbf24] text-[16px] font-bold">
              Call Wins
            </text>
            <text x="310" y="204" textAnchor="middle" className="fill-[#a7a299] text-[13px]">
        ...
        <div className="grid gap-3 text-sm leading-7 text-[var(--ink)]">
          ...
          <div className="rounded-xl border border-[#fbbf24]/20 bg-[#fbbf24]/[0.06] p-4">
  ...
  return (
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="p-6">
        ...
        <h1 className="bg-[linear-gradient(90deg,#ff7a4d,#fbbf24)] bg-clip-text text-4xl font-black tracking-[0.08em] text-transparent md:text-6xl">
          CALL / PUT
        </h1>
          ...
          {day1Config.introCards.map((card) => (
            <div
              ...
              className={cn(
                ...
                card.tone === "gold"
                  ? "border-[#fbbf24]/30 bg-[#fbbf24]/[0.06]"
        ...
        <div className="mt-6 rounded-xl border-l-4 border-[#ff7a4d] bg-[var(--surface-2)] p-4 text-sm leading-7 text-[var(--ink)]">
  ...
  return (
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="grid gap-5 p-6 lg:grid-cols-[1fr_1fr]">
        ...
        <div className="lg:col-span-2 rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-5">
  ...
  return (
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="flex min-h-[430px] flex-col items-center justify-center p-6 text-center">
        ...
        <div className="bg-[linear-gradient(90deg,#ff7a4d,#fbbf24)] bg-clip-text text-4xl font-black tracking-[0.1em] text-transparent md:text-5xl">
  ...
  return (
    <div className="scene-enter grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
      <TerminalCard className="overflow-hidden">
        ...
        <div className="p-5">
          <div className="mx-auto mb-5 flex h-24 w-24 items-center justify-center rounded-full bg-[linear-gradient(135deg,#fbbf24,#b9863a)] font-terminal text-3xl font-black text-[#0b1018] shadow-[var(--shadow)]">
            L
          </div>
      ...
      <TerminalCard className="overflow-hidden">
        ...
        <div className="space-y-4 p-5">
          {client.dialogue.map((line) => (
            <div
              key={line}
              className="rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-4 text-lg leading-8 text-[var(--ink)]"
            >
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  selected
                    ? "border-[#fbbf24]/70 bg-[#fbbf24]/[0.08] shadow-[var(--shadow)]"
                    : "border-[var(--border)] bg-[var(--surface-2)] hover:border-[#ff7a4d]/45 hover:bg-[var(--surface-2)]",
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  {selected && (
                    <div className="font-terminal rounded border border-[#fbbf24]/40 px-2 py-1 text-xs text-[var(--notice)]">
                      Selected
                    </div>
                  )}
                </div>
          ...
          <div
            className={cn(
              ...
              selectedProduct === correctProductId
                ...
                : "border-[#fbbf24] bg-[#fbbf24]/[0.06] text-[var(--notice)]",
            )}
          >
            {productMessage}
          </div>
            ...
            return (
              <label
                ...
                className={cn(
                  ...
                  checked
                    ? "border-[#ff7a4d]/60 bg-[var(--surface-2)]"
                    : "border-[var(--border)] bg-[var(--surface-2)] hover:border-[#ff7a4d]/35",
                )}
              >
                <input
                  type="checkbox"
                  ...
                  className="mt-1 h-4 w-4 accent-[#ff7a4d]"
                />
                <div>
  ...
  return (
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="p-5">
        ...
        <div className="market-chart-panel mt-6 rounded-2xl border border-[var(--border)] bg-[var(--surface-2)]/85 p-4">
            ...
            <div
              className={cn(
                ...
                finalShown
                  ...
                  : "border-[#fbbf24]/35 bg-[#fbbf24]/[0.08] text-[var(--notice)]",
              )}
            >
          ...
          <svg viewBox={`0 0 ${chart.width} ${chart.height}`} className="relative z-10 w-full">
            <defs>
              <linearGradient id="marketArea" x1="0" x2="0" y1="0" y2="1">
                <stop offset="0%" stopColor="rgba(255,122,77,0.28)" />
                <stop offset="100%" stopColor="rgba(255,122,77,0)" />
              </linearGradient>
              <filter id="marketGlow" x="-30%" y="-30%" width="160%" height="160%">
                <feDropShadow dx="0" dy="0" stdDeviation="4" floodColor="#ff7a4d" />
              </filter>
            </defs>
            <rect width={chart.width} height={chart.height} rx="10" fill="rgba(255,255,255,0.04)" />
            ...
            {chart.yTicks.map((tick) => (
              <g key={tick}>
                <line
                  ...
                  stroke={tick === market.strike ? "#fbbf24" : "rgba(148,163,184,0.16)"}
                ...
                <text
                  ...
                  textAnchor="end"
                  className={tick === market.strike ? "fill-[#fbbf24] text-[12px]" : "fill-slate-500 text-[12px]"}
                >
                  {formatPoints(tick)}
                </text>
              </g>
            ...
            {activePrices.map((price, index) => (
              <circle
                ...
                fill={price >= market.strike ? "#fbbf24" : "#ff7a4d"}
                opacity={index === activePrices.length - 1 ? 1 : 0.65}
              />
            ))}

            <circle cx={latestX} cy={latestY} r="13" fill="none" stroke="#ff7a4d" strokeWidth="2" opacity="0.35">
            ...
            <text x={latestX + 12} y={latestY - 12} className="fill-[#ff7a4d] text-[13px] font-bold">
              {formatPoints(latestPrice)}
            </text>
        ...
        {finalShown ? (
          ...
          <div className="mt-5 rounded-xl border-l-4 border-[#fbbf24] bg-[#fbbf24]/[0.06] p-4 text-sm leading-7 text-[var(--notice)]">
...
function ScoreBadge({ score }) {
  const tone =
    score === "A"
      ...
      : score === "B" || score === "B-"
        ? "border-[#fbbf24]/40 bg-[#fbbf24]/[0.08] text-[var(--notice)]"
        : score === "C"
      ...
      <div className="space-y-5 p-5">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          {[
            ...
            <div
              key={label}
              className="flex items-center justify-between rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-4"
            >
        ...
        <div className="rounded-xl border-l-4 border-[#fbbf24] bg-[#fbbf24]/[0.06] p-4 text-base leading-8 text-[var(--notice)]">
          {score.martinComment}
        </div>
      </div>
    </TerminalCard>
  ...
  return (
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="flex min-h-[520px] flex-col items-center justify-center p-6 text-center">
        <div className="bg-[linear-gradient(90deg,#ff7a4d,#fbbf24)] bg-clip-text text-5xl font-black tracking-[0.12em] text-transparent md:text-6xl">
          Day One Complete
        </div>
        <div className="mt-8 grid w-full max-w-2xl gap-3 text-left">
          {summary.map((item) => (
            <div
              key={item}
              className="rounded-xl border border-[var(--border)] bg-[var(--surface-2)] px-4 py-3 text-sm leading-7 text-[var(--ink)]"
            >
...
function Day2IntroPanel() {
  ...
  return (
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="grid gap-6 p-6 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="flex flex-col items-center justify-center rounded-2xl border border-[#fbbf24]/20 bg-[#fbbf24]/[0.05] p-6 text-center">
          <div className="mb-5 flex h-28 w-28 items-center justify-center rounded-full bg-[linear-gradient(135deg,#fbbf24,#ff7a4d)] font-terminal text-5xl font-black text-[#0b1018] shadow-[var(--shadow)]">
            M
          </div>
        ...
        <div className="space-y-3">
          {lines.map((line, index) => (
            <div key={line} className="rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-4">
              ...
              className={cn(
                ...
                item.tone === "good"
                  ...
                  : item.tone === "danger"
                    ...
                    : "border-[#fbbf24]/30 bg-[#fbbf24]/[0.07]",
              )}
            >
              <div className="font-terminal text-xs tracking-[0.16em] text-[var(--muted)]">
                {item.label}
    ...
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="grid gap-6 p-6 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-5">
          ...
          <div className="space-y-4">
            <div className="mx-auto w-44 rounded-2xl border border-[#ff7a4d]/50 bg-[var(--surface-2)] p-4 text-center">
            ...
            <div className="grid grid-cols-2 gap-5">
              <div className="rounded-2xl border border-green-400/35 bg-green-400/[0.08] p-4 text-center">
              ...
              <div className="rounded-2xl border border-red-500/35 bg-red-500/[0.08] p-4 text-center">
            ...
            <div className="grid grid-cols-3 gap-3 text-center">
              {["22,653", "21,500", "20,405"].map((price, index) => (
                <div key={`${price}-${index}`} className="rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-3">
      ...
      <div className="space-y-6 p-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {[
            ...
            <div key={title} className="rounded-2xl border border-[#fbbf24]/20 bg-[#fbbf24]/[0.05] p-4">
        ...
        <div className="rounded-xl border-l-4 border-[#ff7a4d] bg-[var(--surface-2)] p-4 text-base leading-8 text-[var(--ink)]">
  ...
  return (
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="flex min-h-[430px] flex-col items-center justify-center p-6 text-center">
        ...
        <div className="bg-[linear-gradient(90deg,#ff7a4d,#fbbf24)] bg-clip-text text-4xl font-black tracking-[0.08em] text-transparent md:text-5xl">
...
function ResearchTerminalPanel({
  ...
  return (
    <TerminalCard className="scene-enter overflow-hidden">
      <TerminalHeader label={title} accent={accent} />
      <div className="space-y-5 p-5">
        <div className="rounded-xl border border-[#ff7a4d]/20 bg-[#ff7a4d]/[0.04] p-4 text-sm leading-7 text-[var(--ink)]">
        ...
        <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-4 text-xs leading-6 text-[var(--muted)]">
          {footerHint}
        </div>
      </div>
    </TerminalCard>
  ...
  return (
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="grid gap-6 p-6 lg:grid-cols-[0.85fr_1.15fr]">
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-5">
          <div className="mb-5 flex items-center gap-4">
            <div className="flex h-20 w-20 items-center justify-center rounded-xl border border-[#fbbf24]/30 bg-[#fbbf24]/[0.08] font-terminal text-4xl font-black text-[var(--notice)]">
              W
            </div>
            <div>
          ...
          <div className="grid gap-3">
            {profileRows.map(([label, value]) => (
              <div key={label} className="rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-3">
                <div className="font-terminal text-xs tracking-[0.14em] text-[var(--muted)]">
                  {label}
                </div>
        ...
        <div className="rounded-2xl border border-[#fbbf24]/20 bg-[#fbbf24]/[0.05] p-5">
          <div className="font-terminal mb-4 text-xs tracking-[0.18em] text-[var(--notice)]">
            Client Dialogue
          </div>
          <div className="space-y-4">
            {client.dialogue.map((line) => (
              <div key={line} className="rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-4 text-base leading-8 text-[var(--ink)]">
                Mr. Wang: “{line}”
              </div>
            ))}
          </div>
          ...
          {tree.links.map(([fromId, toId]) => {
            ...
            return (
              <line
                ...
                x2={to.x}
                y2={to.y}
                stroke={hot ? "rgba(251,191,36,0.48)" : "rgba(255,122,77,0.28)"}
        ...
        {tree.nodes.map((node) => (
          <div
            ...
            className={cn(
              ...
              node.hot
                ? "border-[#fbbf24]/70 bg-[#fbbf24]/[0.12]"
                : node.terminal
          ...
          >
            ...
            {typeof node.payoff === "number" && (
              <div className="mt-2 space-y-2">
                ...
                <div className={cn("rounded border px-2 py-1 text-xs font-black", node.hot ? "border-[#fbbf24]/40 text-[var(--notice)]" : "border-[var(--border)] text-[var(--muted)]")}>
...
function BinomialPricingTool({
  ...
  return (
    <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface-2)]/85 p-5">
      <div className="mb-5 flex flex-wrap items-start justify-between gap-3">
        ...
        <div
          className={cn(
            ...
            isBarrier
              ? "border-[#fbbf24]/30 bg-[#fbbf24]/[0.07] text-[var(--notice)]"
              : "border-[#ff7a4d]/30 bg-[var(--surface-2)] text-[var(--accent)]",
          )}
        >
      ...
      >
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-4">
          ...
          <div className="grid gap-3">
              ...
              return (
                <label key={key} className="grid gap-2">
                  ...
                  >
                    {label}
                    {isBarrierRow && (
                      <span className="rounded-full border border-[#fbbf24]/50 bg-[#fbbf24]/[0.12] px-2 py-0.5 text-[9px] font-black tracking-[0.18em] text-[var(--notice)]">
                        🔓 NEW
                      </span>
                    )}
                  </span>
                  <input
                    ...
                    className={cn(
                      ...
                      isBarrierRow
                        ? "border-[#fbbf24]/45 focus:border-[#fbbf24]"
                        : "border-[var(--border)] focus:border-[#ff7a4d]",
                    )}
                  />
                </label>
              );
            ...
            <label className="grid gap-2">
              ...
              <div className="rounded-xl border border-[var(--border)] bg-black/40 px-3 py-2 font-terminal text-sm text-[var(--muted)]">
                {params.steps} steps (modeling choice, no need to look up)
              </div>
            </label>
          </div>

          <div className="mt-4 grid gap-3 rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-3 text-xs leading-6 text-[var(--muted)]">
            <div>
              Up factor u:
          ...
          {!isBarrier && day2ParamIssues.length > 0 && (
            <div className="mt-4 rounded-xl border border-orange-500/40 bg-orange-500/[0.08] p-3 text-xs leading-5 text-orange-300">
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-4">
          <div
            className={cn(
              "relative min-w-0 overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--bg)]",
                ...
                <div
                  ...
                  className={cn(
                    ...
                    isTerminal && node.inTheMoney
                      ? "border-[#fbbf24]/65 bg-[#fbbf24]/[0.1]"
                      : "border-[#ff7a4d]/35 bg-[var(--surface-2)]",
                  )}
                  style={{ left: `${node.x}%`, top: `${node.y}%` }}
                >
                  <div className="font-terminal text-[10px] tracking-[0.12em] text-[var(--muted)]">
                  ...
                  {isTerminal && (
                    <div className={cn("mt-1 rounded border px-2 py-1 text-[10px] font-black", node.inTheMoney ? "border-[#fbbf24]/35 text-[var(--notice)]" : "border-[var(--border)] text-[var(--muted)]")}>
          ...
          {isBarrier ? (
            <div className="mt-4 grid gap-3 md:grid-cols-2">
              ...
              <div className="rounded-2xl border border-[#fbbf24]/25 bg-[#fbbf24]/[0.06] p-4">
                <div className="font-terminal text-xs tracking-[0.18em] text-[var(--notice)]">
      ...
      {selectedQuote !== undefined && (
        <div className="mt-5 rounded-2xl border border-[#fbbf24]/25 bg-[#fbbf24]/[0.05] p-5">
          <div className="mb-4">
          ...
          <label className="grid max-w-xs gap-2">
            ...
            <input
              ...
              className="rounded-xl border border-[#fbbf24]/35 bg-[var(--surface-2)] px-4 py-3 font-terminal text-2xl font-black text-[var(--accent)] outline-none transition focus:border-[#fbbf24]"
            />
          </label>
        </div>
      )}
...
function BinomialFormulaPanel() {
  ...
  return (
    <div className="rounded-2xl border border-[#fbbf24]/25 bg-[#fbbf24]/[0.05] p-5">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        {steps.map((step) => (
          <div key={step.title} className="rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-4">
            <div className="font-terminal text-xs tracking-[0.16em] text-[var(--accent)]">
              {step.title}
            </div>
            <div className="mt-3 rounded-xl border border-[var(--border)] bg-[var(--surface-2)] px-3 py-2 font-terminal text-sm text-[var(--notice)]">
              {step.formula}
            </div>
      ...
      <div className="mt-5 rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-4">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          {symbols.map(([symbol, meaning]) => (
            <div key={symbol} className="rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-3">
      ...
      <div className="mt-4 rounded-xl border-l-4 border-[#ff7a4d] bg-[var(--surface-2)] p-4 text-sm leading-7 text-[var(--ink)]">
      ...
      <div className="space-y-5 p-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {[
            ...
            <div key={text} className="rounded-2xl border border-[#fbbf24]/20 bg-[#fbbf24]/[0.05] p-4 text-sm leading-7 text-[var(--notice)]">
...
function Day2QuoteSliderPanel({
  ...
  const content = (
    <>
      ...
      <div className="space-y-6 p-6">
        <div className="grid gap-4 md:grid-cols-4">
          {[
            ["Your Quote", `${selectedQuote} pts`, "#ff7a4d"],
            ["Model Theoretical Price", `${liveTheoretical} pts`, "#fbbf24"],
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-5">
          <div className="mb-4 flex items-center justify-between gap-4">
            ...
            <div className={cn("rounded-xl border px-4 py-2 font-terminal text-xs tracking-[0.14em]", toneClass)}>
              {quoteAnalysis.label}
            </div>
          </div>
          ...
          <input
            ...
            className="w-full touch-manipulation accent-[#ff7a4d]"
          />
        ...
        <div className={cn("rounded-xl border-l-4 p-4 text-base leading-8", toneClass)}>
  ...
  if (embedded) {
    return (
      <div className="overflow-hidden rounded-2xl border border-[#fbbf24]/25 bg-[#fbbf24]/[0.04] shadow-[var(--shadow)]">
        {content}
      </div>
    );
  }
      ...
      <div className="grid gap-6 p-6 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="rounded-2xl border border-[#fbbf24]/20 bg-[#fbbf24]/[0.05] p-5">
          <div className="mb-4 flex items-center gap-4">
            <div className="flex h-16 w-16 items-center justify-center rounded-xl border border-[#fbbf24]/30 bg-black/40 font-terminal text-3xl font-black text-[var(--notice)]">
              W
            </div>
            <div>
              <div className="font-terminal text-xs tracking-[0.18em] text-[var(--notice)]">
          ...
          <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-5 text-xl font-black leading-9 text-[var(--ink)]">
      ...
      <div className="p-5">
        ...
        {finalShown ? (
          <div className="scene-enter mt-6 grid gap-4 md:grid-cols-4">
            ...
            <div className={cn("rounded-2xl border p-4", accepted && (payoff - quote) >= 0 ? "border-green-400/20 bg-green-400/[0.05]" : "border-[var(--border)] bg-[var(--surface-2)]")}>
            ...
            <div className={cn("rounded-2xl border p-4", accepted ? (deskPnl >= 0 ? "border-green-400/20 bg-green-400/[0.05]" : "border-red-500/25 bg-red-500/[0.06]") : "border-[var(--border)] bg-[var(--surface-2)]")}>
  ...
  return (
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="space-y-5 p-6">
        ...
        <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-4 text-sm leading-7 text-[var(--ink)]">
        ...
        <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-4 text-sm leading-7 text-[var(--muted)]">
...
function Day3IntroPanel() {
  return (
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="grid gap-6 p-6 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="rounded-2xl border border-[#fbbf24]/25 bg-[#fbbf24]/[0.06] p-6">
          <div className="font-terminal mb-3 text-xs tracking-[0.2em] text-[var(--notice)]">
            BARRIER OPTION
          </div>
              ...
              return (
                <g key={`${price}-${index}`}>
                  <circle
                    ...
                    cy={y}
                    r={danger ? 9 : 6}
                    fill={danger ? "#ef4444" : "#ff7a4d"}
                    stroke={danger ? "#fecaca" : "#cdd9f5"}
                    strokeWidth="2"
                  />
                  <text x={x} y={y - 14} textAnchor="middle" className={danger ? "fill-red-300 text-[12px] font-bold" : "fill-[#d2cec6] text-[12px]"}>
                    {formatPoints(price)}
                  </text>
                </g>
              );
        ...
        <div className="rounded-2xl border border-[#fbbf24]/25 bg-[#fbbf24]/[0.06] p-5">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ...
              <div key={title} className="rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-4">
                <div className="font-terminal text-xs tracking-[0.16em] text-[var(--accent)]">
                  {title}
                </div>
                <p className="mt-3 text-sm leading-7 text-[var(--ink)]">{text}</p>
          ...
          <div className="mt-4 rounded-xl border-l-4 border-[#fbbf24] bg-[var(--surface-2)] p-4 text-sm leading-7 text-[var(--notice)]">
...
function Day3CompareVanillaPanel({ selectedQuote, quoteAnalysis, onUpdateQuote, onUpdateTheoretical }) {
  return (
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="space-y-5 p-6">
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-2xl border border-[var(--border-strong)] bg-[var(--surface-2)] p-5">
            <div className="font-terminal mb-3 text-xs tracking-[0.18em] text-[var(--accent)]">
              Vanilla Call Option
            </div>
          ...
          <div className="rounded-2xl border border-[#fbbf24]/30 bg-[#fbbf24]/[0.06] p-5">
            <div className="font-terminal mb-3 text-xs tracking-[0.18em] text-[var(--notice)]">
      ...
      <div className="space-y-5 p-5">
        ...
        <div className="grid gap-4 lg:grid-cols-[0.75fr_1.25fr]">
          <div className="rounded-2xl border border-[#fbbf24]/20 bg-[#fbbf24]/[0.05] p-4">
            ...
            <div className="mt-2 text-xl font-black text-[var(--ink)]">{selectedProductName}</div>
            <div className="mt-4 rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-3 text-sm leading-7 text-[var(--ink)]">
              Current price:
            ...
            <div
              className={cn(
                "mt-3 rounded-xl border px-3 py-2 font-terminal text-xs tracking-[0.14em]",
                knockedNow
                  ? "border-red-500/40 bg-red-500/[0.08] text-[var(--neg)]"
          ...
          <div className="market-chart-panel rounded-2xl border border-[var(--border)] bg-[var(--surface-2)]/85 p-4">
            <svg viewBox={`0 0 ${chart.width} ${chart.height}`} className="h-auto w-full" role="img" aria-label="Day 3 barrier option market path">
              ...
              <line x1="58" x2="780" y1={strikeY} y2={strikeY} stroke="#fbbf24" strokeWidth="2" strokeDasharray="6 7" />
              <text x="625" y={strikeY - 10} className="fill-[#fbbf24] text-[13px] font-bold">
                Strike {formatPoints(market.strike)}
              </text>
              <polyline
                points={activeLine}
                fill="none"
                stroke={knockedNow ? "#ef4444" : "#ff7a4d"}
                strokeWidth="4"
                strokeLinejoin="round"
                strokeLinecap="round"
                className="chart-tension"
                ...
                return (
                  <g key={`${price}-${index}`}>
                    ...
                    <text
                      ...
                      textAnchor="middle"
                      className={danger ? "fill-red-300 text-[12px] font-bold" : "fill-[#d2cec6] text-[12px]"}
                    >
                      {formatPoints(price)}
                    </text>
                  </g>
  ...
  return (
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="space-y-5 p-6">
        ...
        <div className="rounded-xl border-l-4 border-red-400 bg-red-500/[0.06] p-4 text-base leading-8 text-[var(--neg)]">
        ...
        <div className="grid gap-4 lg:grid-cols-[0.75fr_1.25fr]">
          ...
          <div className="market-chart-panel rounded-2xl border border-[var(--border)] bg-[var(--surface-2)]/85 p-4">
            <svg viewBox={`0 0 ${chart.width} ${chart.height}`} className="h-auto w-full" role="img" aria-label="Day 4 CBBC market path">
              ...
              <line x1="58" x2="780" y1={strikeY} y2={strikeY} stroke="#fbbf24" strokeWidth="2" strokeDasharray="6 7" />
              <text x="612" y={strikeY - 10} className="fill-[#fbbf24] text-[13px] font-bold">
                Vanilla Put Strike {formatPoints(market.strike)}
              </text>
              <polyline
                points={activeLine}
                fill="none"
                stroke={mceNow ? "#ef4444" : "#ff7a4d"}
                strokeWidth="4"
                strokeLinejoin="round"
                strokeLinecap="round"
                className="chart-tension"
      ...
      {Array.from({ length: total }).map((_, i) => (
        <span
          ...
          className={cn(
            ...
            i === index
              ? "border-[#fbbf24]/70 bg-[#fbbf24]/[0.12] text-[var(--notice)]"
              : i < index
          ...
          <div className="rounded-2xl border border-[#fbbf24]/20 bg-[#fbbf24]/[0.05] p-5">
            ...
            <div className="space-y-4">
              {client.dialogue.map((line) => (
                <div
                  key={line}
                  className="rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-4 text-base leading-8 text-[var(--ink)]"
                >
                  {profile.name}: “{line}”
                </div>
              ))}
    ...
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="grid gap-6 p-6 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-5">
          ...
          <div className="text-5xl font-black text-[var(--accent)]">{selectedQuote} pts</div>
          <div className="mt-4 rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-3 text-sm leading-7 text-[var(--muted)]">
    ...
    <TerminalCard className="scene-enter overflow-hidden">
      ...
      <div className="space-y-5 p-6">
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <div className="flex items-center justify-between rounded-2xl border border-[var(--border)] bg-[var(--surface-2)] p-4">
              ...
              <div className="flex h-full flex-col p-5">
                ...
                <div className="mt-5 pt-2">
                  <button
                    ...
                    className="font-terminal w-full rounded-xl border border-[var(--border)] bg-[var(--surface-2)] px-4 py-2 text-xs font-bold tracking-[0.16em] text-[var(--accent)] transition duration-300 hover:bg-[var(--accent-weak)] hover:text-[var(--accent-strong)]"
                  >
